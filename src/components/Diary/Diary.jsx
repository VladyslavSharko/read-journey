...
import { selectReadingProgress } from "../../redux/books/selectors";
import { getBookInfo } from "../../redux/books/operations";
      ...
      <div className={css.diaryContentContainer}>
        {activeTab === "diary" ? (
          <div className={css.diaryContent}>
            {readingProgress.map((entry, index) => (
              <div key={index} className={css.containerProgressInfo}>
                <div className={css.progressItem}>
                  <p className={css.progressDate}>{entry.progress}</p>
                  <p className={css.progressPersent}>{entry.progress}%</p>
                  <p className={css.progressMinutes}>{entry.minutes} minutes</p>
                </div>

                <div className={css.pagesInfo}>
                  <p className={css.pagesAmount}>{entry.pages} pages</p>
                  ...
                  <div className={css.pagesPerHour}>
